...
export default function Panelsip() {
  return (
    <section className="bg-white overflow-hidden" id="panelsip">
          ...
          <div className="relative lg:ml-10">
            ...
            <blockquote className="relative">
              ...
              <div className="text-2xl leading-9 font-medium text-gray-900">
                <p>
                  El Panel SIP (Structural Insulated Panel) o Panel Sandwich OSB, un moderno y completo sistema estructural auto soportante usado para la construcción, conformado por un alma de espuma rígida de Poliestireno de alta densidad (EPS).
